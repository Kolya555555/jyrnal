...
<!-- Виведення головного вмісту сторінки -->
      <h1 align="center" >Категорія:<br> "<? echo $category ?>"</h1>
...
<div class="container">
    <div class="product-container">
        <?php
            ...
            $electronics = mysqli_query($connect, "SELECT * FROM `electronics` WHERE `electronics`.`category` = '$category'and `electronics`.`count` > 0");
